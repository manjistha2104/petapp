  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // bookingId is returned from the backend
...
<div className="mb-8">
  ...
  />
        ...
        <p className="text-lg font-semibold text-gray-700">
          Your Booking ID is: <span className="text-blue-600">{bookingId}</span>
        </p>
        
        <p className="text-lg mt-2">
          Our support team will contact you shortly regarding further payment.
        </p>
        <button
