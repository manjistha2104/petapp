...
import IconMenuServices from "@/components/icon/menu/IconMenuServices";
            ...
            <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
              ...
              <li className="nav-item">
                <Link href="/services" className="group">
                  <div className="flex items-center">
                    <IconMenuServices className="shrink-0 group-hover:!text-primary" />
                    <span className="text-black dark:text-[#506690] dark:group-hover:text-white-dark ltr:pl-3 rtl:pr-3">
                      {t("Services")}
                    </span>
                  </div>
              ...
              <li className="menu nav-item">
                ...
                >
                  <ul className="sub-menu text-gray-500">
                    <li>
                      <Link href="/banner">{t("Home Banner")}</Link>
                    </li>
                    <li>
                      <Link href="/homecategories">{t("Home Categories")}</Link>
                    </li>

                    <li>
                      <Link href="/homeservices">{t("Home Services")}</Link>
                    </li>
                  </ul>
                </AnimateHeight>
              </li>
