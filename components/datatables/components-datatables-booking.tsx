...
const ComponentsDatatablesBooking = () => {
  ...
  const [isViewModalOpen, setIsViewModalOpen] = useState(false); // 👈 New modal for viewing
  const [viewBooking, setViewBooking] = useState(null); // 👈 Store selected booking
            ...
            },
            {
              ...
              render: (record) => (
                <div className="flex items-center gap-2">
                  ...
                  {/* View Button */}
                  <ActionIcon color="teal" onClick={() => handleViewClick(record)}>
                    <IconEye />
                  </ActionIcon>
    ...
    >
      {viewBooking && (
        <div className="space-y-3">
          ...
          <p><strong>Service:</strong> {viewBooking.selectedService}</p>
        </div>
      )}
    </Modal>
